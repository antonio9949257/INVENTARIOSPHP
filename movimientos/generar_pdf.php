...
class PDF extends FPDF
{
    ...
    function FancyTable($header, $data)
    {
        ...
        // Cabecera
        $w = array(15, 50, 30, 25, 40, 30); // Anchos de las columnas (ID, Producto, Tipo, Cantidad, Fecha, Observaciones)
...
$header = array('ID', 'Producto', 'Tipo', 'Cantidad', 'Fecha', 'Observaciones');
